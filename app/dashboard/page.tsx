...
import { Users, ShieldCheck, Settings, Shield } from "lucide-react"
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        {canManageRoles && (
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">Page Permissions</div>
              <p className="text-xs text-muted-foreground">View page access permissions</p>
              <Button asChild className="mt-4 w-full">
